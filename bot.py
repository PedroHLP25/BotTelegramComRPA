...
CHAVE_API = "6195970052:AAG6w_mKj2yDLCiu6JyJJH9xkw3KyjJndHo"
...
def Computacao_ReceberPDF(mensagem):
    ...
    pyautogui.click(x=472, y=456)
    pyautogui.click(x=1037, y=784)
...
def grade(mensagem):
    texto = """
    Escolha sua engenharia para receber o pdf com a grade e os horários! (Clique em uma opção)
